...
* What is the devlopment life cycle?
:PROPERTIES:
:HTML_CONTAINER_CLASS: activity
:END:
** Learn It
...
1. Specification Requirements
   ...
   - At the end od this stage in the cycle, everyone should be aware of
   ...
   - By the end of this phase, a specification document will be drawn up, that can be refered to throughout the rest of the development.
2. Software Design
   ...
   - At this stage, mockups of the User Interface (UI) are often created.
3. Implementaion
...
- Compose a bulleted list of the disadvanytages of the Waterfall Model.
** Research It
:PROPERTIES:
:HTML_CONTAINER_CLASS: research
:END:
...
- Compose a bulleted list of the disadvanytages of the Incremental Model.
** Research It
:PROPERTIES:
:HTML_CONTAINER_CLASS: research
:END:
...
- Compose a bulleted list of the disadvanytages of the Spiral Model.
** Research It
:PROPERTIES:
:HTML_CONTAINER_CLASS: research
:END:
...
- Compose a bulleted list of the disadvanytages of the V-shaped Model.
